...
function recursive_find_route (self, app, basedir, routedir, relpath, prefix) {
        ...
        if (stats.isFile()) {
            if (endsWith(file, ".js")) {
				...
				try {
                	...
                	if (self.routeMap.hasOwnProperty(r)) {
                		console.log("WARNING!! Route " + r + " [ " + f + " vs " + self.routeMap[r] + " ]");
                		throw new Error("Duplate route " + r);
                	}
                	self.routeMap[r] = f;
                	
					console.log("route [" + r + "]  -  {" + f + ".js}");
				} catch (e) {
            ...
            recursive_find_route (self, app, basedir, routedir, relpath + "/" + file, prefix);
        }
    });
}
...
WebdevAssistant.prototype.loadRoutes = function (app, routedir, prefix) {
	recursive_find_route(this, app, this.basedir, routedir, '', prefix);
};
...
WebdevAssistant.prototype.getRouteMap = function () {
