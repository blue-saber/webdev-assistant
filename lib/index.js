...
function WebdevAssistant () {
	...
	this.setAuthenticationPath = function (authpath) {
		self.authenticationPath = authpath;
	}
	...
	this.loadEntities = entities_loader;
	...
	this.isAuthenticated = function (req, res, next) {
		if (req.session.authenticated) {
			...
			req.redirect(self.authenticationPath);
		}
	};

	this.getUserBaseClass = function() {
		return UserBaseClass;
	}

	this.currentUser = function (req) {
	...
	this.authenticate = function (req, userid, userObj) {
	...
	this.getUserObject = function (req) {
		return req.session.userObj;
	};
}
